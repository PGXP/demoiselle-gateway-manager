...
app.directive('fluxo', [function () {
        return {
            ...
            templateUrl: 'views/partials/fluxo.html',
            link: function (scope, elem, $attrs) {
...
app.directive('fluxoProduto', [function () {
        return {
            ...
            templateUrl: 'views/partials/fluxo-produto.html',
            link: function (scope, elem, $attrs) {
...
app.directive('faseStatus', [function () {
        return {
            ...
            templateUrl: 'views/partials/fase-status.html',
            link: function (scope, elem, $attrs) {
...
app.directive('anexos', function () {
    return {
        ...
        templateUrl: 'views/partials/anexo.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('observacoes', function () {
    return {
        ...
        templateUrl: 'views/partials/observacoes.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('proximaFase', function () {
    return {
        ...
        templateUrl: 'views/partials/proxima-fase.html',
...
app.directive('historicoFase', function () {
    return {
        ...
        templateUrl: 'views/partials/historico-fase.html'
    };
});
...
app.directive('interessados', function () {
    return {
        ...
        templateUrl: 'views/partials/interessados.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('campoUsuario', function () {
    return {
        ...
        templateUrl: 'views/partials/campo-usuario.html',
        link: function (scope, element, attributes) {
...
app.directive('membros', function () {
    return {
        ...
        templateUrl: 'views/partials/membros.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('referencias', function () {
    return {
        ...
        templateUrl: 'views/partials/referencias.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtosDaFase', function () {
    return {
        ...
        templateUrl: 'views/partials/produtos-da-fase.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtotema', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/produto-tema.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('referenciaCadastro', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/referencia-cadastro.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtofabricante', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/produto-fabricante.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtofornecedor', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/produto-fornecedor.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtolicenciamento', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/produto-licenciamento.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtoplataformatecnologica', function () {
    return {
        restrict: 'E',
        templateUrl: 'views/partials/produto-plataformatecnologica.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('sistemausuario', function () {
    return {
        ...
        templateUrl: 'views/partials/sistema-usuario.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('sistemaproduto', function () {
    return {
        ...
        templateUrl: 'views/partials/sistema-produto.html',
        link: function (scope, elem, $attrs) {
        }
    };
});
...
app.directive('produtoSeguir', ['AuthService', 'AlertService', 'ProdutoService', function (AuthService, AlertService, ProdutoService) {
        return {
            restrict: 'E',
            scope: {
                id: '='
            },
            templateUrl: 'views/partials/produto-seguir.html',
            link: function (scope, elem, $attrs) {
                if (AuthService.isAuthenticated()) {
                    scope.$watch("id", function (newValue, oldValue) {
                        scope.usuarioSeguindo = false;
                        scope.seguirProduto = function () {
                            if (scope.id) {
                                ProdutoService.seguirProduto(scope.id).then(function (data) {
                                    scope.usuarioSeguindo = !scope.usuarioSeguindo;
                                    if (scope.usuarioSeguindo === true) {
                                        AlertService.addWithTimeout('success', 'Você começou a seguir este o produto, todas as movimentações relacionados a ele, você será notificado');
                                    } else {
                                        AlertService.addWithTimeout('success', 'Você deixou de seguir este produto, por tanto não será notificado sobre ele');
                                    }
                                }, function (error) {
                                    AlertService.addWithTimeout('danger', 'Não foi possível seguir o produto');
                                });
                            } else {
                                AlertService.addWithTimeout('info', 'Para seguir um Produto é necessário estar logado');
                            }

                        }

                        function checkStatusSeguindo(id) {
                            if (id) {
                                ProdutoService.usuarioSeguindo(id).then(function (data) {
                                    scope.usuarioSeguindo = data;
                                }, function (resp) {
                                    scope.usuarioSeguindo = false;
                                });
                            }
...
app.directive('produtoInfo', ['ProdutoService', function (ProdutoService) {
        return {
            restrict: 'E',
            scope: {
                produtoId: '='
            },
            templateUrl: 'views/partials/produto-info.html',
            link: function (scope, elem, $attrs) {
                scope.$watch("produtoId", function (newValue, oldValue) {
                    ProdutoService.info(scope.produtoId).then(function (data) {
                        scope.info = data;
                    }, function (error) {
                    });
                });
...
app.directive('faseInfo', ['FaseService', function (FaseService) {
        return {
            restrict: 'E',
            scope: {
                faseId: '='
            },
            templateUrl: 'views/partials/fase-info.html',
            link: function (scope, element, attrs) {
                scope.$watch("faseId", function (newValue, oldValue) {
                    FaseService.info(scope.faseId).then(function (data) {
                        scope.faseinfo = data;
                    }, function (error) {
                    });
                });
...
app.directive('ngAnaliseSituacao', function () {
    return {
        scope: {
            situacao: '@'
        },
...
app.directive('itemFase', function () {
    return {
        scope: {
            fase: '='
        },
        templateUrl: 'views/partials/item-fase.html',
        link: function (scope, elem, $attrs) {
